...
<img width="200" height="200" alt="VR$QMT4BQVS(3O$RU$GU9T8" src="https://github.com/user-attachments/assets/6da3771e-611b-439f-808a-abaec9109321" />
  ...
  **`Mini 6.xml`**   
<img width="250" height="200" alt="VR$QMT4BQVS(3O$RU$GU9T8" src="https://github.com/user-attachments/assets/bc3603ee-7e86-4932-9147-44e011e2c83e" />
...
把布局文件layout拖到🤏
    ...
    C:\Users\（每個人的使用者名稱不一樣）\AppData\Roaming\foobar2000-v2\eslyric-data\layout
...
如果找不到，可以去安裝資料夾找有沒有 `profie` 這個資料夾📁，這個是攜帶版的，裡面會有後面的
...
下面的可以按照個人喜好調，要是想實現上圖效果可以跟著調👣

因為每個人的電腦螢幕大小不同🖥💻，數值也不同，可以自己把控，調的像一點就行。🔧

因為外面的介面和全螢幕的介面是獨立的設定所以先進`全螢幕模式`🔳
...
如果你們出現了左側標題等行高字體顯示一半，顯示不全🚫

![image](https://github.com/user-attachments/assets/9fc7e46c-a947-402d-8a05-49bf4515944e)

可以試一試改一下字號`font-size=" "` .xml中有標註

🔗[https://github.com/ESLyric/release/wiki/%E9%9D%A2%E6%9D%BF%E5%B8%83%E5%B1%80](https://github.com/ESLyric/release/wiki/%E9%9D%A2%E6%9D%BF%E5%B8%83%E5%B1%80)

調整至合適大小，改一下就存檔，會即時顯示❗

每個人電腦螢幕和字體設定大小不一樣就這樣↕
...
![自訂按鈕](https://github.com/user-attachments/assets/10824db4-c4e4-42db-ab75-f33d68ff6c84)

歌詞懸浮提示

鼠標指針懸浮在進度條上麵時，懸浮所在位置上方會有歌詞的提示，點擊時會從句子開頭播放
...
將 `show-lyric-tooltip=”1” ` 改爲0（1是開啟，0是關閉）
...
放這個路徑
    ...
    C:\Users\（每個人的使用者名稱不一樣）\AppData\Roaming\foobar2000-v2\eslyric-data\scripts

![image](https://github.com/user-attachments/assets/7fd4ecc1-2047-4559-9222-7f11a8ddd409)

如果找不到，可以去安裝資料夾找有沒有 `profie` 這個資料夾，裡面會有後面的
...
只有`EX`源是逐字，酷狗有沒有逐字看運氣🗿

再打開`卡拉OK模式`下面的`增強歌詞`

因為外面的介面和全螢幕的介面是獨立的設定所以兩個都要選✅✅
...
打開軟體設定，選擇通配符移除，裡面的`*`代表若干字

如果你要去除像這樣的  `演唱：林俊傑` ，然後有很多歌曲開頭也有這個，你可以填  ` 演唱：*`🗿
...
# 9️⃣ 字體 🤠  
推薦  
Poppins-Black（英文西語） + NotoSansSC-ExtraBold(中日) + NotoSans-Black（俄文）按需組合

（需要字體工具將NotoSansSC-ExtraBold的英文西語替換成Poppins-Black，俄文替換成NotoSans-Black）
